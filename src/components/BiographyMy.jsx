    ...
    <section className="biography-my ">
      ...
      <div id="aboutme" className="biography-my__story">
        ...
        <div className="biography-my__text">
          ...
          without work experience, it was difficult to get the desired position
          right away. And I got a lower position, promising myself career
          growth. And so it happened. Then it happened that I moved to Poland
          and met different developers. As before, surrounding people were from
          IT, but that time a different kind of it. I thought it was
          interesting, I heard about the Epam school. This is how my first
          acquaintance with JS began, then the first site, then React. And this,
          I'll tell you, is addictive. This is really a titanic work, but when
